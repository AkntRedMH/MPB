...
#define  SET_CS1  	SPI_CS_GPIO_Port->BSRR = SPI_CS_Pin
#define  CLR_CS1  	SPI_CS_GPIO_Port->BSRR = (uint32_t)SPI_CS_Pin << 16
...
extern __IO uint16_t ADS1220_Tick;

void ADS1220Init(void);
void ADS1220Config(uint8_t ch);
void ADS1220_GetData(void);	
